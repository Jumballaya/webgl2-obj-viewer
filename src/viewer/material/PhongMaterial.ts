...
export class PhongMaterial extends Material {
  ...
  public clone() {
    return new PhongMaterial(this.webgl, this.shader, this.config);
  }
  ...
  public bindUbo(ubo: UBO) {
    ...
    this.webgl.shaders[this.shader]?.uniform("u_texture_normal", {
      type: "texture",
      value: normalTexId,
    });
    this.webgl.shaders[this.shader]?.uniform("u_texture_specular", {
      type: "texture",
      value: specularTexId,
    });
