...
export class LightManager {
    ...
    public newLight(type: keyof LightTypes) {
        switch (type) {
            case 'point': return this.createPointLight();
            case 'spot': return this.createSpotLight();
        }
    }

    public updateLight(light: Light) {
        switch (light.type) {
            case 'point': this.updatePointLight(light as PointLight); break;
            case 'spot': this.updateSpotLight(light as SpotLight); break;
        }
        this.ubo.bind();
