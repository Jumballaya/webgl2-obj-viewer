export type ObjToken = ObjVertexToken | ObjTexCoordToken | ObjNormalToken | ObjFaceToken | ObjNumberToken | ObjFaceListToken | ObjStringToken | ObjObjToken | ObjMtlToken | ObjUseMtlToken;
